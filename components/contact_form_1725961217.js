<template>
  <main class="flex justify-center align-center p-10">
    <div class="w-fit max-w-lg p-8 bg-white shadow-lg rounded-lg">
      <div>
        <h3 class="text-black font-semibold text-xl">Let's Build Your Mobile App</h3>
        <p class="mt-3 text-black w-fit">Transform your ideas into reality with our expert mobile development team</p>
      </div>
